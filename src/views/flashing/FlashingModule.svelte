...
<div class="space-y-6">
  ...
  <div class="alert alert-warning">
    ...
    <div>
      <h3 class="font-bold">Beta Feature</h3>
      <p class="text-sm">USB flashing is currently in beta. For production use, please use <strong>ImageUSB</strong> or <strong>Balena Etcher</strong> instead.</p>
    </div>
  </div>
